...
export const ASSET_ID_NOBLE_USDC =
...
export const sunriseAssetMetadata: AssetMetadata = {
	...
	[ASSET_ID_STRISE]: {
		...
		tickerSystem: 'SUNRISE',
		image: 'https://haruflyer.risesunrise.io/strise.svg',
		exponents: 6,
	...
	[ASSET_ID_USDN]: {
		tickerDisplay: 'USDN',
		tickerSystem: 'USDN',
		image: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/noble/images/USDN.svg',
		exponents: 6,
		base: 'uusdn',
		baseExponents: 6,
		bridge: {
	...
	[ASSET_ID_USDY]: {
		tickerDisplay: 'USDY',
		tickerSystem: 'USDY',
		image: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/noble/images/usdy.svg',
		exponents: 18,
		base: 'ausdy',
		baseExponents: 18,
		bridge: {
